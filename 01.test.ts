...
import { puzzle1Part2 } from "./01-2.puzzle.ts";
...
describe("[PUZZLE 1]", () => {
  ...
  it("[Puzzle 1-2] should return 1089", async () => {
    expect(await puzzle1Part2()).toBe(6530);
  });
  ...
  describe("findHowManyTimesZeroIsHit", () => {
    ...
    describe("with countPassThrough: true", () => {
      it("should return 2 hits for default 50 and 99 numbers: -99 +99", () => {
        ...
        const numberOfZeroHits = findHowManyTimesZeroIsHit(
          rotations,
          50,
          99,
          true
